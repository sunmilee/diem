...
sourcesIndex["diem_data_client"] = {"name":"","dirs":[{"name":"diemnet","files":["mod.rs","state.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["diem_rest_client"] = {"name":"","files":["lib.rs","types.rs"]};
...
sourcesIndex["executor"] = {"name":"","dirs":[{"name":"components","dirs":[{"name":"speculation_cache","files":["mod.rs"]}],"files":["apply_chunk_output.rs","chunk_commit_queue.rs","chunk_output.rs","mod.rs"]}],"files":["block_executor_impl.rs","chunk_executor.rs","db_bootstrapper.rs","fuzzing.rs","lib.rs","logging.rs","metrics.rs"]};
...
sourcesIndex["scratchpad"] = {"name":"","dirs":[{"name":"sparse_merkle","dirs":[{"name":"test_utils","files":["mod.rs","naive_smt.rs","proof_reader.rs","proptest_helpers.rs"]}],"files":["batches_update.rs","mod.rs","node.rs","updater.rs","utils.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["state_sync_driver"] = {"name":"","files":["driver.rs","driver_client.rs","driver_factory.rs","error.rs","lib.rs","notification_handlers.rs","storage_synchronizer.rs"]};
